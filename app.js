...
function saveIntervalsData(data){intervalsData=data;localStorage.setItem(INTERVALS_KEY,JSON.stringify(data||null))}
...
async function syncIntervals(force=false){
  ...
  try{
    ...
    toast(force?'Intervals: zsynchronizowano live ✅':'Intervals: dane odświeżone ✅');
    renderAll();
